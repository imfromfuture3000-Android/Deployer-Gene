...
function findAssociatedTokenAddress(owner, mint) {
    return web3_js_1.PublicKey.findProgramAddressSync([owner.toBuffer(), spl_token_1.TOKEN_2022_PROGRAM_ID.toBuffer(), mint.toBuffer()], new web3_js_1.PublicKey('ATokenGPvbdGVxr1b2hvZbsiqW5xWH25efTNsLJA8knL'))[0];
}
